...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("010000? ????? ????? 101 ????? 00100 11", srai   , I, R(rd) = As(src1, imm & 0x1f, BITS(src1, 5, 5), Shift_right));
  INSTPAT("0100000 ????? ????? 101 ????? 01100 11", sra    , I, R(rd) = As(src1, src2 & 0x1f, 1, Shift_right));
